...
> Skill: **Health** · 导出时间: 2026/7/10 15:32:14
...
```json
{"test_case_1":"我最近三个星期每天晚上都只能睡3-4小时，白天头晕乏力，试过喝温牛奶、泡脚都没改善，我该怎么调整？","test_case_2":"我今年35岁，长期坐办公室，平时几乎不运动，最近想每周安排3次低强度锻炼，有没有适合我的个性化建议？","test_case_3":"我最近半个月总是容易饿，体重还轻了2斤，但没有其他不舒服的症状，这种情况需要去看医生吗？"}
```

## 🏆 AI 评测结论

**综合评价：** 所有测试用例均符合Skill的功能和预期行为，回复严格遵守安全边界，提供了个性化、证据支持的健康指导，沟通清晰易懂。
...
```
所有测试用例均符合Skill的功能和预期行为，回复严格遵守安全边界，提供了个性化、证据支持的健康指导，沟通清晰易懂。
```
